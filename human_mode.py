...
def draw_window(win, bird, pipes, base, score, high_score):
    ...
    win.blit(high_score_label, (WIN_WIDTH - high_score_label.get_width() - 10, 90))
...
def main():
    ...
    final_score_label = STAT_FONT.render(f"Final Score: {score}", 1, (255, 255, 255))
    ...
    WIN.blit(restart_label, (WIN_WIDTH//2 - restart_label.get_width()//2, WIN_HEIGHT//2))
